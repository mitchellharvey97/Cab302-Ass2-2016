...
public class AircraftTests {
	...
	public void testUpgradeBookingsOrderSpecific() throws PassengerException, AircraftException {
		...
		List<Passenger> passengers = a.getPassengers();
		assertThat(passengers.get(0), instanceOf(Premium.class));
		assertThat(passengers.get(1), instanceOf(Business.class));
		assertThat(passengers.get(2), instanceOf(First.class));
		assertThat(passengers.get(3), instanceOf(First.class));
	}
